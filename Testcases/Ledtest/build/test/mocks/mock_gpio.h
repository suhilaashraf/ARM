...
#define GPIO_InitPin_ExpectAndReturn(gpiopin, cmock_retval) GPIO_InitPin_CMockExpectAndReturn(__LINE__, gpiopin, cmock_retval)
void GPIO_InitPin_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, GPIOPIN_t* gpiopin, Error_enumStatus_t cmock_to_return);
typedef Error_enumStatus_t (* CMOCK_GPIO_InitPin_CALLBACK)(GPIOPIN_t* gpiopin, int cmock_num_calls);
...
#define GPIO_SetPinValue_ExpectAndReturn(PORT, gpio_pinNumber, gpiopinStatus, cmock_retval) GPIO_SetPinValue_CMockExpectAndReturn(__LINE__, PORT, gpio_pinNumber, gpiopinStatus, cmock_retval)
...
typedef Error_enumStatus_t (* CMOCK_GPIO_SetPinValue_CALLBACK)(void* PORT, uint32_t gpio_pinNumber, uint32_t gpiopinStatus, int cmock_num_calls);
...
#define GPIO_GetPinValue_ExpectAndReturn(PORT, gpio_pinNumber, gpiopinStatus, cmock_retval) GPIO_GetPinValue_CMockExpectAndReturn(__LINE__, PORT, gpio_pinNumber, gpiopinStatus, cmock_retval)
...
typedef Error_enumStatus_t (* CMOCK_GPIO_GetPinValue_CALLBACK)(void* PORT, uint32_t gpio_pinNumber, uint32_t* gpiopinStatus, int cmock_num_calls);
